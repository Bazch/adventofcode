...
public abstract class AbstractDay implements Day {
    ...
    public void readInput(boolean isDebug, boolean isHome){
        if(isHome) {
            FILE_PATH = "C:\\Users\\basv_\\git\\adventofcode\\resources\\2021\\"
                    + this.getClass().getSimpleName() + ".txt";
            FILE_PATH_DEBUG = "C:\\Users\\basv_\\git\\adventofcode\\resources\\2021\\"
                    + this.getClass().getSimpleName() + "_test.txt";
        } else {
            FILE_PATH = "/Users/bvdboomg/personal/adventofcode/resources/2021/"
                    + this.getClass().getSimpleName() + ".txt";
            FILE_PATH_DEBUG = "/Users/bvdboomg/personal/adventofcode/resources/2021/"
                    + this.getClass().getSimpleName() + "_test.txt";
        }
